...
public class DomainApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrderItem i1 = new OrderItem(null, 1, p1.getPrice(), p1, o1);
        OrderItem i2 = new OrderItem(null, 2, p2.getPrice(), p2, o1);
        OrderItem i3 = new OrderItem(null, 1, p2.getPrice(), p2, o2);
        OrderItem i4 = new OrderItem(null, 1, p3.getPrice(), p3, o2);
